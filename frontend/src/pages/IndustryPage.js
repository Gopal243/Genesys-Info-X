...
export default function IndustryPage({
  ...
  const coverImage =
    pageKey === "healthcare"
      ? INDUSTRY_IMAGES.healthcare
      : pageKey === "semiconductors"
        ? INDUSTRY_IMAGES.semiconductors
        : INDUSTRY_IMAGES.technology;

  const deliverCards =
    pageKey === "healthcare"
      ? [
          { title: "RCM & Billing Systems", desc: "Workflow design, coding support, and revenue integrity." },
          { title: "Automation & QA", desc: "Reduce manual effort with reliable, testable automation." },
          { title: "Analytics & Reporting", desc: "Dashboards and insights for operational visibility." },
          { title: "Compliance-ready Delivery", desc: "Security-by-design with disciplined governance." },
          { title: "Integrations", desc: "Connect systems with clean APIs and dependable data flows." },
          { title: "Care Team UX", desc: "Interfaces that support speed, clarity, and usability." },
        ]
      : pageKey === "semiconductors"
        ? [
            { title: "Test Analytics", desc: "Data systems that improve yield, quality, and insights." },
            { title: "Platform Engineering", desc: "High-performance systems for complex engineering programs." },
            { title: "Reliability Tooling", desc: "Validation workflows designed for critical systems." },
            { title: "Data Pipelines", desc: "Clean pipelines and governance for engineering data." },
            { title: "Performance Optimization", desc: "Design for latency, throughput, and stability." },
            { title: "Program Delivery", desc: "Milestones, traceability, and predictable execution." },
          ]
        : [
            { title: "AI Operations", desc: "Production-ready automation for high-impact workflows." },
            { title: "Cloud Modernization", desc: "Platform upgrades that enable faster delivery." },
            { title: "Security-by-Design", desc: "Guardrails integrated into the SDLC." },
            { title: "Data & BI", desc: "Decision dashboards and analytics foundations." },
            { title: "Integrations", desc: "APIs that keep systems clean and scalable." },
            { title: "Product Engineering", desc: "From roadmap to release with enterprise-quality UX." },
          ];

  const useCases =
    pageKey === "healthcare"
      ? [
          { title: "Billing Workflow Automation", desc: "Reduce cycle time with structured automation.", image: INDUSTRY_IMAGES.healthcare },
          { title: "Claims & Coding Analytics", desc: "Improve visibility and accuracy with dashboards.", image: INDUSTRY_IMAGES.technology },
          { title: "Care Team Interfaces", desc: "Modern UX for daily operational efficiency.", image: INDUSTRY_IMAGES.healthcare },
        ]
      : pageKey === "semiconductors"
        ? [
            { title: "Yield & Test Dashboards", desc: "Operational dashboards for engineering outcomes.", image: INDUSTRY_IMAGES.semiconductors },
            { title: "Reliability Programs", desc: "Process tooling for critical validation cycles.", image: INDUSTRY_IMAGES.technology },
            { title: "Performance Workflows", desc: "Systems designed for speed and stability.", image: INDUSTRY_IMAGES.semiconductors },
          ]
        : [
            { title: "Data Platform Modernization", desc: "Scale pipelines and improve system clarity.", image: INDUSTRY_IMAGES.technology },
            { title: "AI-enabled Operations", desc: "Automation that is measurable and reliable.", image: INDUSTRY_IMAGES.technology },
            { title: "Security Governance", desc: "Guardrails that improve delivery speed.", image: INDUSTRY_IMAGES.semiconductors },
          ];
            ...
            <div className="metrics-grid">
              <Reveal delay={0.06}>
                <div className="metric-card">
                  <div className="metric-value">+<span>35</span>%</div>
                  <div className="metric-label">Faster cycle time</div>
                </div>
              </Reveal>
              <Reveal delay={0.12}>
                <div className="metric-card">
                  <div className="metric-value">-<span>28</span>%</div>
                  <div className="metric-label">Reduced manual workload</div>
                </div>
              </Reveal>
              <Reveal delay={0.18}>
                <div className="metric-card">
                  <div className="metric-value">+<span>22</span>%</div>
        ...
        <section className="section" id="delivery-model">
          <div className="container">
            <Reveal>
              ...
              <p className="section-lede muted">
                From discovery to launch—clear steps, clear ownership.
              </p>
            </Reveal>
